=== Ajax Custom CSS/JS ===
Contributors: harry005
Tags: css, ajax, jss, custom , custom css, custom js, css editor , js editor, custom js , custom javascript
...
1. Autocomplete feature in CSS as well as JSS
2. Syntax error highlighter feature
3. Theme and font change feature

== Changelog ==

= 2.0.4 =
* Removed JS hint and JS lint feature because GNU has deemed it a 'non free' license
* JS hint and JS lint feature will be up on this plugin soon
